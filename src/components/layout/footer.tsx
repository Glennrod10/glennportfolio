      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-full bg-overlay/10 backdrop-blur-xl shadow-lg shadow-overlay/5 flex items-center justify-center flex-shrink-0">
        ...
        {/* Bottom Bar */}
        <motion.div
          className="mt-8 pt-6 border-t border-overlay/10 flex flex-col sm:flex-row items-center justify-between gap-2"
          initial={{ opacity: 0 }}
